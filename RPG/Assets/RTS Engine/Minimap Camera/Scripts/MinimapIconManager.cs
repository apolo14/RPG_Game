...
namespace RTSEngine
{
    ...
    public class MinimapIconManager : MonoBehaviour
    {
        ...
        {
            selection.UpdateMinimapIcon(GetNewMinimapIcon(selection.Source.transform, selection.GetMinimapIconSize())); //assign the minimap icon to the selection obj component
