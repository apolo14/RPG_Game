...
namespace RTSEngine
{
    public class LobbyFaction : MonoBehaviour
    {
        ...
        public NPCManager GetNPCManager () { return manager.NPCManagers.Get(npcManagerID); }
        ...
        public void Init (LobbyManager manager, bool playerControlled)
        {
            ...
            npcTypeMenu.AddOptions(this.manager.NPCManagers.GetNames());
            npcManagerID = 0;
        ...
        public void OnFactionNPCManagerUpdated ()
        {
