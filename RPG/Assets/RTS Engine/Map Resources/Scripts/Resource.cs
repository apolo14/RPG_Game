...
namespace RTSEngine
{
    public class Resource : Entity
    {
        ...
        public override void Init(GameManager gameMgr)
        {
            ...
            gameMgr.MinimapIconMgr.AssignIcon(selection); //assign the minimap icon
            ...
            if (collected == false) //if the resource hasn't been collected before now
            {
                ...
                if (secondaryModel != null) //if there's a secondary model, enable it and disable the initial one
                {
                    ...
                    if(secondarySelection != null) //if there's a secondary selection
                    {
                        ...
                        gameMgr.MinimapIconMgr.AssignIcon(selection); //ask the minimap icon manager to create the a minimap icon for this resource and link it to the secondary selection
                    }
                }
