...
namespace RTSEngine
{
    public class EffectObjPool : MonoBehaviour
    {
        ...
        private static Dictionary<string, Queue<EffectObj>> effectObjs = new Dictionary<string, Queue<EffectObj>>(); //this holds all inactive effect objects of different types.
        ...
        public EffectObj SpawnEffectObj(EffectObj prefab, Vector3 spawnPostion, Quaternion spawnRotation = default, Transform parent = null, bool enableLifeTime = true, bool autoLifeTime = true, float lifeTime = 0.0f)
        {
            if (prefab == null)
                return null;
