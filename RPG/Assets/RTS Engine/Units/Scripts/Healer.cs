...
namespace RTSEngine
{
    public class Healer : UnitComponent<Unit>
    {
        ...
        protected override void OnTargetSearch()
        {
            ...
            foreach (Unit u in unit.FactionMgr.GetUnits()) //go through the faction's units list and look for a target unit
