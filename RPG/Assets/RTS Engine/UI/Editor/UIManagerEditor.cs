...
public class UIManagerEditor : Editor
{
    ...
    {
        manager_SO = new SerializedObject((UIManager)target);
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        tabID = GUILayout.Toolbar(tabID, new string[] { "General", "Task Panel", "Selection Panel", "Hover Health Bar", "Peace Time" });
