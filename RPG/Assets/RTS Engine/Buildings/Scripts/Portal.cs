	...
	public class Portal : MonoBehaviour {
        ...
        public void OnMouseClick ()
		{
            ...
            { //if this is the second click (double click)
                ...
                gameMgr.CamMov.LookAt(targetPortal.transform.position); //change the main camera's view to look at the target portal
                gameMgr.CamMov.SetMiniMapCursorPos(targetPortal.transform.position); //change the minimap's cursor position to be over the target portal
            }
		}
