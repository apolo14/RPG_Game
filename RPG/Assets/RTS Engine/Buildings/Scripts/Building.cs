...
namespace RTSEngine
{
    public class Building : FactionEntity
    {
        ...
        public class BonusResource
        {
            ...
            public string GetResourceTypeName () { return resourceType.GetName(); }
            [SerializeField]
        ...
        public override void Init(GameManager gameMgr, int fID, bool free)
        {
            ...
            if (AttackComp) //enable the attack component
        ...
        public void InitPlacementInstance (GameManager gameMgr, int fID, Border buildingCenter = null)
        {
            ...
            Init(gameMgr, fID, false); //init the building
        ...
        public void ToggleResourceBonus(bool enable)
        {
            ...
            foreach (Resource r in CurrentCenter.GetResourcesInRange()) //go through the resources inside the current center
            {
                ...
                {
                    if (r != null && r.GetResourceType().GetName() == bonusResources[i].GetResourceTypeName()) //if the resource is valid and the bonus resource matches this resource type
                    {
        ...
        {
            if (RallyPoint == null || !IsBuilt) //no rally point or the building is not built yet
                return;
