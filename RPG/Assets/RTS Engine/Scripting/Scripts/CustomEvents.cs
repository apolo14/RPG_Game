...
namespace RTSEngine
{
	public class CustomEvents : MonoBehaviour {
        ...
        public delegate void ResourceGeneratorEventHandler(ResourceGenerator resourceGenerator, int generatorID);
        public static event ResourceGeneratorEventHandler ResourceGeneratorFull = delegate { };
        ...
        public delegate void UpgradeEventHandler(Upgrade upgrade);
        ...
        public static event BorderEventHandler BorderResourcesUpdated = delegate { };
		...
		public delegate void GameEventHandler (FactionSlot factionSlot);
        ...
        public static void OnUnitMoveAttempt(Unit Unit) //when the player attempts to move a unit
        {
        ...
        public static void OnBorderResourcesUpdated(Border border)
        {
            BorderResourcesUpdated(border);
        }
        ...
        //Upgrades:
        public static void OnUnitUpgraded (Upgrade upgrade)
        {
        ...
        public static void OnBuildingUpgraded (Upgrade upgrade)
        {
