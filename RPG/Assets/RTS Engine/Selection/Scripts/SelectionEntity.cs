    ...
    public abstract class SelectionEntity : MonoBehaviour
    {
        ...
        public void UpdateMinimapIconColor () //a method that updates the minimap color
        {
            ...
            if (IsFree()) //if this component manages the selection of a free entity
                minimapIcon.GetComponent<MeshRenderer>().material.color = gameMgr.MinimapIconMgr.FreeFactionIconColor; //assign the free faction color
            else
                minimapIcon.GetComponent<MeshRenderer>().material.color = Source.GetColor(); //if not, get the correct faction color
        }
        ...
        public void DisableMinimapIcon() //a method that disables the minimap icon
        {
            ...
            gameMgr.MinimapIconMgr.InactiveMinimapIcons.Add(minimapIcon); //add it to the unused minimap icons list so that it can be used later
            minimapIcon = null;
        }
