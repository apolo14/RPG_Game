...
namespace RTSEngine
{
    public abstract class NPCRegulator<T> : ScriptableObject where T : FactionEntity
    {
        ...
        protected virtual void Init (GameManager gameMgr, NPCManager npcMgr)
        {
            ...
            category = prefabs[0].GetCategory();
        }
        ...
        {
            return amount >= maxAmount || factionMgr.HasReachedLimit(code, category) || pendingAmount >= maxPendingAmount;
        }
