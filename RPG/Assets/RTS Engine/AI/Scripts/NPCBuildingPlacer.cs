...
namespace RTSEngine
{
    public class NPCBuildingPlacer : NPCComponent
    {
            ...
            while (true)
            {
                ...
                if (pendingBuildings[0].buildingInstance != null) //make sure the pending building instance is valid:
                {
                    transform.position = new Vector3(
                            ...
                            gameMgr.TerrainMgr.SampleHeight(transform.position, pendingBuildings[0].buildingInstance.GetRadius(), 0) + gameMgr.PlacementMgr.GetBuildingYOffset(),
        ...
        void PlaceBuilding()
        {
            ...
            gameMgr.BuildingMgr.CreatePlacedInstance(pendingBuildings[0].buildingPrefab, 
