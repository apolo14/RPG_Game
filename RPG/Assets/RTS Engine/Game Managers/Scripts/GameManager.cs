...
namespace RTSEngine
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public static bool initialized { private set; get; } //Are all factions stats ready? 
        ...
        [SerializeField]
        private AudioSource generalAudioSource = null; //The audio source where audio will be played generally unless the audio is local. In that case, it will be played 
        public AudioSource GetGeneralAudioSource () { return generalAudioSource; }
        [SerializeField]
        ...
        public CameraMovement CamMov { private set; get; }
        ...
        void Awake()
        {
            ...
            InputMgr.Init(this); //must be initialize after initializing the multiplayer game factions
            ResourceMgr.OnFactionSlotsInitialized(); //init resources for factions.
            ...
            if (LobbyManager.instance.LobbyFactions.Count <= factions.Count)
            {
                ...
                for (int i = 0; i < LobbyManager.instance.LobbyFactions.Count; i++)
                {
                    factions[i].Init(
                        ...
                        LobbyManager.instance.LobbyFactions[i].GetNPCManager(),
                        gameObject.AddComponent<FactionManager>(), i, this);
                }
        ...
        private void RandomizeFactionSlots(int[] indexSeedList)
        {
            ...
            while(i < indexSeedList.Length) //this seed list provides the randomized faction slot indexes
            {
                ...
                RTSHelper.Swap<Building>(ref factions[i].CapitalBuilding, ref factions[indexSeedList[i]].GetCapitalBuilding());
        ...
        public void WinGame()
        {
            ...
            AudioManager.Play(GetGeneralAudioSource(), winGameAudio, false);
        ...
        {
            AudioManager.Play(GetGeneralAudioSource(), loseGameAudio, false);
